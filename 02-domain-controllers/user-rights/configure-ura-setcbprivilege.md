...
## Rationale
Allows a process to impersonate any user without credentials. This privilege must be empty on Domain Controllers to prevent Tier 0 privilege escalation.

---

## Legacy Impact & Compatibility
* **Operational Impact**: Restricting `SeTcbPrivilege` to `No one (Empty)` protects Domain Controllers filesystem and service execution interfaces. Ensure core directory sync or backup agents do not lose validation access.
