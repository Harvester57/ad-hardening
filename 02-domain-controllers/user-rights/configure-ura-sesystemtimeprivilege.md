...
## Rationale
Enforces that only Administrators and Local Service can change the clock on Domain Controllers, preserving Kerberos ticket lifetimes and authentications.
