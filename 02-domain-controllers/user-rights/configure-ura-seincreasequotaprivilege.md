...
## Rationale
Allows a process to adjust memory quotas for other processes. Restricting this to Administrators, Network Service, and Local Service prevents denial-of-service memory manipulation on Domain Controllers.
