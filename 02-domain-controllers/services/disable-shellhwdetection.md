...
* **GPO Path / Registry Location**:
  ...
  * **Registry Location**: `HKLM\SYSTEM\CurrentControlSet\Services\ShellHWDetection\Start`

---

## Rationale
Domain Controllers represent the highest privilege tier (Tier 0) in the Active Directory forest. Minimizing the execution footprint on these critical servers is an essential hardening guideline. Disabling the Shell Hardware Detection (ShellHWDetection) service directly supports this:
...
4. Create a new Registry Preference (Right-click **Registry -> New -> Registry Item**):
   ...
   * **Key Path**: `SYSTEM\CurrentControlSet\Services\ShellHWDetection`
   * **Value name**: `Start`
...
[Download Script: Configure-DisableShellHWDetection.ps1](../implementation_scripts/Configure-DisableShellHWDetection.ps1)
...
[Download Script: Get-ShellHWDetectionStatus.ps1](../audit_scripts/Get-ShellHWDetectionStatus.ps1)
