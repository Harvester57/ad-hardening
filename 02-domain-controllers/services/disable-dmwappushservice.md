...
* **GPO Path / Registry Location**:
  ...
  * **Registry Location**: `HKLM\SYSTEM\CurrentControlSet\Services\dmwappushservice\Start`

---

## Rationale
Domain Controllers represent the highest privilege tier (Tier 0) in the Active Directory forest. Minimizing the execution footprint on these critical servers is an essential hardening guideline. Disabling the WAP Push Message Routing Service (dmwappushservice) service directly supports this:
...
[Download Script: Configure-Disabledmwappushservice.ps1](../implementation_scripts/Configure-Disabledmwappushservice.ps1)
...
[Download Script: Get-dmwappushserviceStatus.ps1](../audit_scripts/Get-dmwappushserviceStatus.ps1)
