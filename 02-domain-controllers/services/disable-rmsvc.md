...
* **GPO Path / Registry Location**:
  ...
  * **Registry Location**: `HKLM\SYSTEM\CurrentControlSet\Services\RmSvc\Start`

---

## Rationale
Domain Controllers represent the highest privilege tier (Tier 0) in the Active Directory forest. Minimizing the execution footprint on these critical servers is an essential hardening guideline. Disabling the Radio Management Service (RmSvc) service directly supports this:
...
[Download Script: Configure-DisableRmSvc.ps1](../implementation_scripts/Configure-DisableRmSvc.ps1)
...
[Download Script: Get-RmSvcStatus.ps1](../audit_scripts/Get-RmSvcStatus.ps1)
