# [REQ-DC-048] Disable Microsoft Passport Container on Domain Controllers (NgcCtnrSvc)
...
* **GPO Path / Registry Location**:
  ...
  * **Registry Location**: `HKLM\SYSTEM\CurrentControlSet\Services\NgcCtnrSvc\Start`

---

## Rationale
Domain Controllers represent the highest privilege tier (Tier 0) in the Active Directory forest. Minimizing the execution footprint on these critical servers is an essential hardening guideline. Disabling the Microsoft Passport Container (NgcCtnrSvc) service directly supports this:
...
4. Create a new Registry Preference (Right-click **Registry -> New -> Registry Item**):
   ...
   * **Key Path**: `SYSTEM\CurrentControlSet\Services\NgcCtnrSvc`
   * **Value name**: `Start`
...
[Download Script: Configure-DisableNgcCtnrSvc.ps1](../implementation_scripts/Configure-DisableNgcCtnrSvc.ps1)

```powershell
# Configure-DisableNgcCtnrSvc.ps1
...
[Download Script: Get-NgcCtnrSvcStatus.ps1](../audit_scripts/Get-NgcCtnrSvcStatus.ps1)

```powershell
# Get-NgcCtnrSvcStatus.ps1
