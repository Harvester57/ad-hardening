...
* **GPO Path / Registry Location**:
  ...
  * **Registry Location**: `HKLM\SYSTEM\CurrentControlSet\Services\NgcSvc\Start`

---

## Rationale
Domain Controllers represent the highest privilege tier (Tier 0) in the Active Directory forest. Minimizing the execution footprint on these critical servers is an essential hardening guideline. Disabling the Microsoft Passport (NgcSvc) service directly supports this:
...
[Download Script: Configure-DisableNgcSvc.ps1](../implementation_scripts/Configure-DisableNgcSvc.ps1)
...
[Download Script: Get-NgcSvcStatus.ps1](../audit_scripts/Get-NgcSvcStatus.ps1)
