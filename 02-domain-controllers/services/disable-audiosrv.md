...
* **GPO Path / Registry Location**:
  ...
  * **Registry Location**: `HKLM\SYSTEM\CurrentControlSet\Services\Audiosrv\Start`

---

## Rationale
Domain Controllers represent the highest privilege tier (Tier 0) in the Active Directory forest. Minimizing the execution footprint on these critical servers is an essential hardening guideline. Disabling the Windows Audio (Audiosrv) service directly supports this:
...
[Download Script: Configure-DisableAudiosrv.ps1](../implementation_scripts/Configure-DisableAudiosrv.ps1)
...
[Download Script: Get-AudiosrvStatus.ps1](../audit_scripts/Get-AudiosrvStatus.ps1)
