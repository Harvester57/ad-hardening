...
* **GPO Path / Registry Location**:
  ...
  * **Registry Location**: `HKLM\SYSTEM\CurrentControlSet\Services\WpnService\Start`

---

## Rationale
Domain Controllers represent the highest privilege tier (Tier 0) in the Active Directory forest. Minimizing the execution footprint on these critical servers is an essential hardening guideline. Disabling the Windows Push Notifications System Service (WpnService) service directly supports this:
...
4. Create a new Registry Preference (Right-click **Registry -> New -> Registry Item**):
   ...
   * **Key Path**: `SYSTEM\CurrentControlSet\Services\WpnService`
   * **Value name**: `Start`
...
[Download Script: Configure-DisableWpnService.ps1](../implementation_scripts/Configure-DisableWpnService.ps1)
...
[Download Script: Get-WpnServiceStatus.ps1](../audit_scripts/Get-WpnServiceStatus.ps1)
