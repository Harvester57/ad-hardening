...
* **GPO Path / Registry Location**:
  ...
  * **Registry Location**: `HKLM\SYSTEM\CurrentControlSet\Services\wisvc\Start`

---

## Rationale
Domain Controllers represent the highest privilege tier (Tier 0) in the Active Directory forest. Minimizing the execution footprint on these critical servers is an essential hardening guideline. Disabling the Windows Insider Service (wisvc) service directly supports this:
...
[Download Script: Configure-Disablewisvc.ps1](../implementation_scripts/Configure-Disablewisvc.ps1)
...
[Download Script: Get-wisvcStatus.ps1](../audit_scripts/Get-wisvcStatus.ps1)
