...
* **GPO Path / Registry Location**:
  ...
  * **Registry Location**: `HKLM\SYSTEM\CurrentControlSet\Services\stisvc\Start`

---

## Rationale
Domain Controllers represent the highest privilege tier (Tier 0) in the Active Directory forest. Minimizing the execution footprint on these critical servers is an essential hardening guideline. Disabling the Windows Image Acquisition (WIA) (stisvc) service directly supports this:
...
[Download Script: Configure-Disablestisvc.ps1](../implementation_scripts/Configure-Disablestisvc.ps1)
...
[Download Script: Get-stisvcStatus.ps1](../audit_scripts/Get-stisvcStatus.ps1)
