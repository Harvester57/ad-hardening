...
* **GPO Path / Registry Location**:
  ...
  * **Registry Location**: `HKLM\SYSTEM\CurrentControlSet\Services\FrameServer\Start`

---

## Rationale
Domain Controllers represent the highest privilege tier (Tier 0) in the Active Directory forest. Minimizing the execution footprint on these critical servers is an essential hardening guideline. Disabling the Windows Camera Frame Server (FrameServer) service directly supports this:
...
[Download Script: Configure-DisableFrameServer.ps1](../implementation_scripts/Configure-DisableFrameServer.ps1)
...
[Download Script: Get-FrameServerStatus.ps1](../audit_scripts/Get-FrameServerStatus.ps1)
