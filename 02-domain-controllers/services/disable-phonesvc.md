...
* **GPO Path / Registry Location**:
  ...
  * **Registry Location**: `HKLM\SYSTEM\CurrentControlSet\Services\PhoneSvc\Start`

---

## Rationale
Domain Controllers represent the highest privilege tier (Tier 0) in the Active Directory forest. Minimizing the execution footprint on these critical servers is an essential hardening guideline. Disabling the Phone Service (PhoneSvc) service directly supports this:
...
[Download Script: Configure-DisablePhoneSvc.ps1](../implementation_scripts/Configure-DisablePhoneSvc.ps1)
...
[Download Script: Get-PhoneSvcStatus.ps1](../audit_scripts/Get-PhoneSvcStatus.ps1)
