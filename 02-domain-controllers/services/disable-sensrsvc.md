...
* **GPO Path / Registry Location**:
  ...
  * **Registry Location**: `HKLM\SYSTEM\CurrentControlSet\Services\SensrSvc\Start`

---

## Rationale
Domain Controllers represent the highest privilege tier (Tier 0) in the Active Directory forest. Minimizing the execution footprint on these critical servers is an essential hardening guideline. Disabling the Sensor Monitoring Service (SensrSvc) service directly supports this:
...
[Download Script: Configure-DisableSensrSvc.ps1](../implementation_scripts/Configure-DisableSensrSvc.ps1)
...
[Download Script: Get-SensrSvcStatus.ps1](../audit_scripts/Get-SensrSvcStatus.ps1)
