...
* **GPO Path / Registry Location**:
  ...
  * **Registry Location**: `HKLM\SYSTEM\CurrentControlSet\Services\bthserv\Start`

---

## Rationale
Domain Controllers represent the highest privilege tier (Tier 0) in the Active Directory forest. Minimizing the execution footprint on these critical servers is an essential hardening guideline. Disabling the Bluetooth Support Service (bthserv) service directly supports this:
...
[Download Script: Configure-Disablebthserv.ps1](../implementation_scripts/Configure-Disablebthserv.ps1)
...
[Download Script: Get-bthservStatus.ps1](../audit_scripts/Get-bthservStatus.ps1)
