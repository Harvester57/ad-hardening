...
## Target Scope
* **Applicable Systems**: Privileged Access Workstations (PAWs) dedicated to Tier 0 and critical administrative functions. *(For Tier 2 Client Workstations and Member Servers, refer to standard baseline [REQ-END-100](../../08-endpoints/user-rights/configure-ura-sebackupprivilege.md)).* *(For Domain Controllers, refer to [REQ-DC-110](../../02-domain-controllers/user-rights/configure-ura-sebackupprivilege.md)).*
...
[Download Script: Configure-PawUraSeBackupPrivilege.ps1](../implementation_scripts/Configure-PawUraSeBackupPrivilege.ps1)
...
[Download Script: Get-PawUraSeBackupPrivilegeStatus.ps1](../audit_scripts/Get-PawUraSeBackupPrivilegeStatus.ps1)
