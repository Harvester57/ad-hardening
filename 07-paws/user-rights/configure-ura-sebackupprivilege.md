...
## Rationale
Allows users to bypass file permissions to read all files on the system. Restricting it to Administrators prevents data exfiltration by unauthorized users.
