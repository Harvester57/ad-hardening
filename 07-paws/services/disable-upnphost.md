...
## Rationale
To minimize the attack surface of standard client endpoints and member servers, all unnecessary system services must be disabled. Disabling the UPnP Device Host (upnphost) service directly supports this on Privileged Access Workstations:
