# [REQ-END-053] Disable Xbox Accessory Management Service Service (XboxGipSvc)
...
## Rationale
To minimize the attack surface of standard client endpoints and member servers, all unnecessary system services must be disabled. Disabling the Xbox Accessory Management Service (XboxGipSvc) service directly supports this:
...
* **Verification**: Administrators must verify that client operations do not rely on local Xbox Accessory Management Service capabilities before domain-wide enforcement.
