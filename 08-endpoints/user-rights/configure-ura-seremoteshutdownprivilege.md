...
## Target Scope
* **Applicable Systems**: Tier 2 client workstations and member servers. *(For Tier 0 Privileged Access Workstations, refer to tightened baseline [REQ-PAW-103](../../07-paws/user-rights/configure-ura-seremoteshutdownprivilege.md)).* *(For Domain Controllers, refer to [REQ-DC-123](../../02-domain-controllers/user-rights/configure-ura-seremoteshutdownprivilege.md)).*
...
[Download Script: Configure-UraSeRemoteShutdownPrivilege.ps1](../implementation_scripts/Configure-UraSeRemoteShutdownPrivilege.ps1)
...
[Download Script: Get-UraSeRemoteShutdownPrivilegeStatus.ps1](../audit_scripts/Get-UraSeRemoteShutdownPrivilegeStatus.ps1)
