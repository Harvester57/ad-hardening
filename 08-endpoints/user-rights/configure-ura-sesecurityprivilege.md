...
## Target Scope
* **Applicable Systems**: Tier 2 client workstations and member servers. *(For Tier 0 Privileged Access Workstations, refer to tightened baseline [REQ-PAW-107](../../07-paws/user-rights/configure-ura-sesecurityprivilege.md)).* *(For Domain Controllers, refer to [REQ-DC-129](../../02-domain-controllers/user-rights/configure-ura-sesecurityprivilege.md)).*
...
[Download Script: Configure-UraSeSecurityPrivilege.ps1](../implementation_scripts/Configure-UraSeSecurityPrivilege.ps1)
...
[Download Script: Get-UraSeSecurityPrivilegeStatus.ps1](../audit_scripts/Get-UraSeSecurityPrivilegeStatus.ps1)
