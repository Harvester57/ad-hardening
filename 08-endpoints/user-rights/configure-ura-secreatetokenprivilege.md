...
## Target Scope
* **Applicable Systems**: Tier 2 client workstations and member servers. *(For Tier 0 Privileged Access Workstations, refer to tightened baseline [REQ-PAW-098](../../07-paws/user-rights/configure-ura-secreatetokenprivilege.md)).* *(For Domain Controllers, refer to [REQ-DC-114](../../02-domain-controllers/user-rights/configure-ura-secreatetokenprivilege.md)).*
