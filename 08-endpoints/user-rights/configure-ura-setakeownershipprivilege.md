...
## Target Scope
* **Applicable Systems**: Tier 2 client workstations and member servers. *(For Tier 0 Privileged Access Workstations, refer to tightened baseline [REQ-PAW-112](../../07-paws/user-rights/configure-ura-setakeownershipprivilege.md)).* *(For Domain Controllers, refer to [REQ-DC-135](../../02-domain-controllers/user-rights/configure-ura-setakeownershipprivilege.md)).*
...
[Download Script: Configure-UraSeTakeOwnershipPrivilege.ps1](../implementation_scripts/Configure-UraSeTakeOwnershipPrivilege.ps1)
...
[Download Script: Get-UraSeTakeOwnershipPrivilegeStatus.ps1](../audit_scripts/Get-UraSeTakeOwnershipPrivilegeStatus.ps1)
