...
## Target Scope
* **Applicable Systems**: Tier 2 client workstations and member servers. *(For Tier 0 Privileged Access Workstations, refer to tightened baseline [REQ-PAW-093](../../07-paws/user-rights/configure-ura-senetworklogonright.md)).* *(For Domain Controllers, refer to [REQ-DC-104](../../02-domain-controllers/user-rights/configure-ura-senetworklogonright.md)).*
...
6. Configure the security principal allocation to: `*S-1-5-32-544 (Administrators), *S-1-5-32-555 (Remote Desktop Users)`.
...
[Download Script: Configure-UraSeNetworkLogonRight.ps1](../implementation_scripts/Configure-UraSeNetworkLogonRight.ps1)
...
[Download Script: Get-UraSeNetworkLogonRightStatus.ps1](../audit_scripts/Get-UraSeNetworkLogonRightStatus.ps1)
